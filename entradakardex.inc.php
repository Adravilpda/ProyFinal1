...
<?php
		...
		$sql1="select * from bandejaalumno where receptor='$cig' and remitente!='$nom' order by fecha";
...
<?php	
	while ($fila1=mysqli_fetch_array($resultado1)){
		...
		$sqlvistou="UPDATE bandejaalumno SET visto='si' where receptor='$fila1[1]' and remitente='$fila1[2]'";
